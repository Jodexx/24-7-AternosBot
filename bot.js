...
const consolebotlistlogin = data["consolebotlistlogin"];
...
function makeBot ([_u, _p], ix) {
  return new Promise((resolve, reject) => {
    ...
    bot.on('login', function() {
      console.log('\x1b[35m')
      console.log(consoleloginmessage,'\x1b[0m')
      bot.chat('/register ' + password + ' ' + password)
      bot.chat('/login ' + password)
      console.log('\x1b[33m')
      console.log(consoleauthmessage,'\x1b[0m')
    })
    bot.on('chat', (username, message) => {
      ...
      switch (message) {
        ...
        bot.on('spawn', function() {
          ...
          console.log('\x1b[36m')
          console.log(consolespawnmessage,'\x1b[0m')
          bot.setControlState('forward', true)
          bot.setControlState('jump', true)
          bot.setControlState('sprint', true)
        })
        bot.on('death', function() {
          ...
          console.log('\x1b[31m')
          console.log(consoledeathmessage,'\x1b[0m')
        })
        bot.on('kicked', function() {
          console.log('\x1b[31m')
          console.log(botkickmessage)
        })
...
async function main () {
  ...
  console.log(consolebotlistlogin)
}
